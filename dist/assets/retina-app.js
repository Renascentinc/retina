...
define('retina-app/routes/add', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
define('retina-app/routes/application', ['exports', 'ember'], function (exports, _ember) {
	exports['default'] = _ember['default'].Route.extend({});
});
define('retina-app/routes/scan', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
define('retina-app/routes/search', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
define('retina-app/routes/transfer', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
...
define("retina-app/templates/application", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    var child2 = (function () {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          var el0 = dom.createDocumentFragment();
          var el1 = dom.createElement("span");
          dom.setAttribute(el1, "class", "glyphicon glyphicon-wrench");
          dom.setAttribute(el1, "aria-hidden", "true");
          dom.appendChild(el0, el1);
          return el0;
        },
    ...
    return {
      ...
      statements: [["block", "link-to", ["add"], ["class", "icon-btn", "id", "add-icon"], 0, null, ["loc", [null, [4, 2], [4, 128]]]], ["block", "link-to", ["search"], ["class", "icon-btn", "id", "search-icon"], 1, null, ["loc", [null, [6, 8], [6, 143]]]], ["block", "link-to", ["scan"], ["class", "icon-btn", "id", "tool-icon"], 2, null, ["loc", [null, [8, 2], [8, 133]]]], ["content", "outlet", ["loc", [null, [21, 4], [21, 14]]], 0, 0, 0, 0]],
      locals: [],
...
if (!runningTests) {
  require("retina-app/app")["default"].create({"name":"retina-app","version":"0.0.0+2d54ac2a"});
}
